...
global.roomCaptionDef = "I Wanna Soulless 4";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rBeforeAvoidance;    //sets which room to begin with
