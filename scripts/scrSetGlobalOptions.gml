...
global.roomCaptionDef = "Soulless";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rPortalRoom;    //sets which room to begin with
