...
global.avatars = ini_read_real("Settings","Avatars",true);
global.track_ver = ini_read_real("Settings","Track_ver",0);
...
global.portalButton[0] = ini_read_real("Controls","PortalRoom",ord("Q"));
