...
scanline_Colour.x = scanline(crt_uv, 1.0);
    slowscan_Colour.x = slowscan(crt_uv, 1.0);
...
void main()
{
   ...
   // Sum the colour contribution of each layer   
    ...
    gl_FragColor = vec4( v_vColour.rgb * Colour, v_vColour.a);
}
